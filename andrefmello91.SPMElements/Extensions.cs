...
namespace andrefmello91.SPMElements
{
    ...
    public static class Extensions
    {
	    ...
	    public static SPMElements.Node GetByPosition(this IEnumerable<SPMElements.Node> nodes, Point position) => nodes.First(node => position == node.Position);
        ...
        public static void SetStringerDimensions(this IEnumerable<NLPanel> panels, IEnumerable<SPMElements.Stringer> stringers)
        {
